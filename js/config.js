...
var l_messages = [
	...
	"You are to obey commands from employers such as Old Sport, Phone Guy etc. 4a. Ranking: Old sport and phone guy Head of Security Security!",
        "Listen to staff, they have the final say. - If an admin says he is going to warn you and warns you, do not continue to argue with them!",
	...
	"You can only have a maximum of three fading door entries/exits in your base (Fading doors that are used as doors to funnel users) you can have up to four fading door windows, boxes, etc. BUT they must be linked with buttons (not keypads) and said buttons must be toggled!",
	...
	"Do not flame in the chat - This means arguing, spamming, being toxic, etc. in Chats. - Commenting on Staff decisions may also fall under this Category and is punishable with warnings, mutes and kicks!",
	...
	"You need to have a license which you get from the mayor, without it you may be AOS, if seen with a gun out in public, with it you may not be AOS!",
