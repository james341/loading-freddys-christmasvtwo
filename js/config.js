...
var l_messages = [
	...
	"Use common sense when being active and chatting on the server. Don't encourage people to break rules, don't spam staff, etc. Use your brain!",
        "The radio chat may only be used to deliver important in-character information. We don't use ads!",
	...
	"All synthetic ground vehicles and the T90 are immune to being stolen. SU/MACE can roll to C4 props within the enemy base. A unit may only attempt this once every 5 minutes, and the unit must call staff and perform a quick “/me plants C4” before rolling against the staff member!",
